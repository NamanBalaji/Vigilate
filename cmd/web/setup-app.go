...
import (
	...
	"github.com/NamanBalaji/vigilate/internal/channeldata"
	"github.com/NamanBalaji/vigilate/internal/config"
	"github.com/NamanBalaji/vigilate/internal/driver"
	"github.com/NamanBalaji/vigilate/internal/handlers"
	"github.com/NamanBalaji/vigilate/internal/helpers"
...
func setupApp() (*string, error) {
	...
	preferenceMap["pusher-port"] = "4001"
	...
	wsClient = pusher.Client{
		...
		Key:    *pusherKey,
		Secure: *pusherSecure,
		Host:   fmt.Sprintf("%s:%s", *pusherHost, "4001"),
	}

	log.Println("Host", fmt.Sprintf("%s:%s", *pusherHost, "4001"))
